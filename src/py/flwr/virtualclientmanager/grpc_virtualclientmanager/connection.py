...
from flwr.proto.transport_pb2_grpc import FlowerServiceVCMStub
...
def insecure_grpc_connection(
...
) -> Iterator[Tuple[Callable[[], RemoteClientManagerMessage], Callable[[VirtualClientManagerMessage], None]]]:
    ...
    queue: Queue[VirtualClientManagerMessage] = Queue(  # pylint: disable=unsubscriptable-object
        maxsize=1
    )
