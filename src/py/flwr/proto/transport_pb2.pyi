...
class VirtualClientManagerMessage(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"get_pool_size_res",b"get_pool_size_res",u"is_available_res",b"is_available_res",u"msg",b"msg",u"wakeup_clients_res",b"wakeup_clients_res"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"get_pool_size_res",b"get_pool_size_res",u"is_available_res",b"is_available_res",u"msg",b"msg",u"wakeup_clients_res",b"wakeup_clients_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["get_pool_size_res","wakeup_clients_res","is_available_res"]: ...
...
class RemoteClientManagerMessage(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"get_pool_size",b"get_pool_size",u"is_available",b"is_available",u"msg",b"msg",u"wakeup_clients",b"wakeup_clients"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"get_pool_size",b"get_pool_size",u"is_available",b"is_available",u"msg",b"msg",u"wakeup_clients",b"wakeup_clients"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["get_pool_size","wakeup_clients","is_available"]: ...
